...
start_q_table = "Models/three_common_qtable.pickle" # None or Filename
                    ...
                    for iiii in range(- SIGHT, SIGHT+1):
                        for iiiii in range(- SIGHT, SIGHT+1):
                                for iiiiii in range(- SIGHT, SIGHT+1):
                                    q_table[((i, ii), (iii, iiii), (iiiii, iiiiii))] = [np.random.uniform(-5, 0) for i in range(4)]
...
# with open(f"Models/three_common_qtable.pickle", "wb") as f:
